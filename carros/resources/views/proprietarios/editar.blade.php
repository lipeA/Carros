...
<body>
    ...
    <header class="bg-white w-full p-11 flex items-center justify-items-start gap-8 border-b-2">
        ...
        <h2 class="text-4xl">Cadastrar um novo Proprietario</h2>
    </header>
    <main class=" flex justify-center items-center bg-[#F3F4F6] w-6/6 pt-16 ">
        <div class="">
            <form action=" {{ route('donos.atualizar', ['id' => $dono->id]) }} " method="POST">
                @csrf
                @method('PUT');
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="nome" id="nome"  onkeyup="this.value = this.value.toUpperCase()" value=" {{ $dono->nome}} "
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="telefone" id="telefone" value=" {{$dono->telefone}} "
                                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input id="cnh" name="cnh" type="text" maxlength="10" value=" {{$dono->cnh}} "
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="sm:col-span-3">
