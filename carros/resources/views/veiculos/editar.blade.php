        ...
        <div class="">
            <form action=" {{route('veiculo.atualizar', ['id'=> $carro->id])}} " method="POST">
                    ...
                    <div class="border-b border-gray-900/10 pb-12">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input type="text" name="modelo" id="modelo" maxlength="15" onkeyup="this.value = this.value.toUpperCase()" value="{{$carro->veiculo}}"
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input id="placa" name="placa" type="text" maxlength="10" value="{{$carro->placa}}"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input id="ano" name="ano" type="text" maxlength="4" value="{{$carro->ano}}"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                </div>
                            </div>
                ...
                <div class="mt-6 mb-10 flex items-center justify-end gap-x-6">
                    <button type="button" class="text-sm font-semibold leading-6 text-gray-900"> <a href=" {{route('veiculos.index')}} ">Cancel</a></button>
                    <button type="submit"
